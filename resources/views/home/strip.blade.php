...
<div class="container">
    ...
    <h1 style="text-align: center; font-size:20px;margin-bottom:10px">Pay Using Your Cart --TotalAmount is :${{ $totlalprice }}</h1>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form 
                            role="form" 
                            action="{{ route('post',["totlalprice"=>$totlalprice]) }}" 
                            method="post" 
